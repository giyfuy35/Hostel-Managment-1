...
public class staff extends AppCompatActivity {
    ...
    private DatabaseReference root= db.getReference().child("Staff  Registration");
    //
    DatePicker picker;
    Button displayDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(staff.this,staff.class);
                startActivity(i);
            }
        });
        ...
        phoneaddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(staff.this, hostel.guw.phoneaddress.class);
                startActivity(i);
...
//        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //
                Intent i= new Intent(staff.this,dashboard.class);
                startActivity(i);
                ...
                Toast.makeText(staff.this, "Suceesfully added", Toast.LENGTH_SHORT).show();
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(staff.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (progressDialog.isShowing())
                            progressDialog.dismiss();
                        Toast.makeText(staff.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
