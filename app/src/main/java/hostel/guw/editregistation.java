...
public class editregistation extends AppCompatActivity {
    ...
    private DatabaseReference root= db.getReference().child("Edit Registration");
    //
    DatePicker picker;
    Button displayDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editregistation);
        upload=findViewById(R.id.uploads);
        select=findViewById(R.id.selects);
        edit=findViewById(R.id.edit);
//        sUsername = dateofregistration.getText().toString();
...
//        }
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(editregistation.this,editregistation.class);
                startActivity(i);
            }
        });
        ...
        phoneaddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(editregistation.this, hostel.guw.phoneaddress.class);
                startActivity(i);

            }
        });
        //
        sUsernames = name.getText().toString();
        if (sUsernames.matches("")) {
            Toast.makeText(this, "You did not enter a date ", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(editregistation.this,dashboard.class);
                startActivity(i);
                ...
                Toast.makeText(editregistation.this, "Suceesfully added", Toast.LENGTH_SHORT).show();
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(editregistation.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (progressDialog.isShowing())
                            progressDialog.dismiss();
                        Toast.makeText(editregistation.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
