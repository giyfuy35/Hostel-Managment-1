...
public class subcatagory extends AppCompatActivity {
    ...
    private DatabaseReference root= db.getReference().child(" Hostel Registration");
    //
    DatePicker picker;
    Button displayDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(subcatagory.this,subcatagory.class);
                startActivity(i);
            }
        });
        ...
        phoneaddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(subcatagory.this, hostel.guw.phoneaddress.class);
                startActivity(i);
...
//        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //
                Intent i= new Intent(subcatagory.this,dashboard.class);
                startActivity(i);
                ...
                Toast.makeText(subcatagory.this, "Suceesfully added", Toast.LENGTH_SHORT).show();
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(subcatagory.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (progressDialog.isShowing())
                            progressDialog.dismiss();
                        Toast.makeText(subcatagory.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
