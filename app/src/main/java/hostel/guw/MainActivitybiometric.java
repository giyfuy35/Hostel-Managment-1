...
public class MainActivitybiometric extends AppCompatActivity {
    //
    ...
    private BiometricPrompt.AuthenticationCallback callback = new BiometricPrompt.AuthenticationCallback() {
        ...
        public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
            ...
            Intent i=new Intent(MainActivitybiometric.this,dashboard.class);
            startActivity(i);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activitybiometric);
